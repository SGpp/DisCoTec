...
config.checkpointFrequency = int( parser.get('application','checkpointFrequency') )
...
with open('ginstance/offset.txt', 'w') as f:
    new_offset_string = "offset " + str(int(offset + config.ncombi/config.checkpointFrequency)) + "\n"
