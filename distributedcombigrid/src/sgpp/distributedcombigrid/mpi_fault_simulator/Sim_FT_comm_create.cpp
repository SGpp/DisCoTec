...
int simft::Sim_FT_MPI_Comm_create(simft::Sim_FT_MPI_Comm f_comm, MPI_Group group, simft::Sim_FT_MPI_Comm *newcomm){
	...
	if(MPI_SUCCESS == Ret){
		...
		simft::Sim_FT_Initialize_new_comm((newcomm), true); //TODO: if "reroot" implemented, set to false
