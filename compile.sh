...
#Helium
#scons -j 8 ISGENE=0 VERBOSE=1 COMPILE_BOOST_TESTS=1 RUN_BOOST_TESTS=0 RUN_CPPLINT=0 BUILD_STATICLIB=0 CC=mpicc.mpich FC=mpifort.mpich CXX=mpicxx.mpich OPT=1 TIMING=0 UNIFORMDECOMPOSITION=1 ENABLEFT=0 USE_VTK=0 #DEBUG_OUTPUT=1

#HLRS
#scons -j 8 ISGENE=0 VERBOSE=1 COMPILE_BOOST_TESTS=1 RUN_BOOST_TESTS=0 RUN_CPPLINT=0 BUILD_STATICLIB=0 CC=cc FC= CXX=CC OPT=1 TIMING=0 UNIFORMDECOMPOSITION=1 ENABLEFT=0 USE_VTK=0 #DEBUG_OUTPUT=1
