...
SOURCE_PATH=${SOURCE_PATH:=/p/scratch/widediscotecjsc/3-systems/measurements/3-systems_3x2048/}
DSG_NUM=${DSG_NUM:=2}
SOURCE_FILE=${SOURCE_FILE:=${SOURCE_PATH}/dsg_${DSG_NUM}_step*_0}

TARGET_PATH_NG=${TARGET_PATH_NG:=//hppfs/work/pn36xu/di39qun2/3-systems/measurements/3-systems_8x2048/}
